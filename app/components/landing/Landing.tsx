...
export const Landing = () =>
    <section id="home" className="flex flex-col lg:gap-5 items-center">
      <div
      ...
      <div
        className="max-w-300 xl:max-h-80 lg:px-10 flex flex-col-reverse lg:flex-row-reverse
      ...
      <div className="md:my-5 lg:mt-0 md:mx-10 xl:mx-10 md:mb-10 flex flex-col items-center">
        <PolygonHeading extClass="text-primary bg-foreground md:rounded-t-xl">Skills</PolygonHeading>
